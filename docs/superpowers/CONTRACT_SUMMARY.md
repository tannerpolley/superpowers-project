...
| `companion-interface` | Use when a Superpowers Project workflow should create or update a repo-owned Agent-Native visual-plan MDX artifact for rich review. | None | `None` |
