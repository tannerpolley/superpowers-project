...
try {
    ...
    @(
        ...
        "| 72 | resolve-issue | docs/superpowers/issues/72-live-sync-tracker-align-validation.md | P2 | ready | pwsh.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\validate.ps1 | active issue mirror |"
    ...
    Add-Check -Name "selector accepts active backlog markdown" -Ok ($activeBacklogSelection.exit_code -eq 0 -and $activeBacklogSelection.json.selected_candidate_id -eq "72") -Reason $activeBacklogSelection.raw
