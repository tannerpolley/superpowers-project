...
description: Namespace wrapper for the deployed Superpowers Project context skill.
---

# Project Context

Deployed user-level skill path: `C:\Users\Tanner\.agents\skills\project-context\SKILL.md`
