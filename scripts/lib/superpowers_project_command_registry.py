...
_COMMANDS: dict[str, str] = {
    ...
    'scripts/test-decision-ledger.sh': 'command_validate_decision_ledger',
    ...
    'scripts/validate-artifact-review-card.sh': 'command_unimplemented',
    'scripts/validate-auto-mode-authorization.sh': 'command_unimplemented',
