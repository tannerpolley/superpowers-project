...
$pluginWrapperFile = Join-Path $repoRoot "skills\project-writing-plan\SKILL.md"
...
$scenarios = @(
    ...
    Invoke-Scenario "plugin wrapper points to deployed user skill" {
        ...
        Assert-Contains $text "name: project-writing-plan" "missing wrapper name"
        Assert-Contains $text "namespace wrapper" "missing wrapper declaration"
        Assert-Contains $text "C:\Users\Tanner\.agents\skills\project-writing-plan\SKILL.md" "missing deployed path"
