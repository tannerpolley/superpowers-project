...
- Treat this repo as source. Treat `/home/tnnrpolley21/.codex/plugins/superpowers-project` and `/home/tnnrpolley21/.agents/skills/advanced-user-input` as deployed copies.
- Do not edit the live deployed copies directly when this repo is available; edit this repo, validate, then run `scripts/sync-live.sh`.
